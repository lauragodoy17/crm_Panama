    ...
    <div class="min-height-200px">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-md-8 col-sm-12">
            <div class="title"><h4>Reporte cantidad de adopciones</h4></div>
          </div>
        </div>
      </div>
      ...
      <div class="sm-section">
        <div class="sm-section-head">
          <span class="sm-sec-icon"><i class="bi bi-calendar3"></i></span>
          <span class="sm-section-title">Por periodo</span>
        </div>
        <div class="sm-section-body">
          <form action="php/cant_adop_excel.php" method="POST">
            <div class="row">
              <?php if ($_SESSION['tipo'] == 1 || $_SESSION['tipo'] == 2 || $_SESSION['tipo'] == 7): ?>
              <div class="col-md-4 col-12 mb-3">
                <label class="control-label">Promotor <small style="color:red;">*</small></label>
              ...
              <div class="col-md-3 col-12 mb-3">
                ...
                <select name="periodo" id="periodo1" class="form-control">
                  <?php
            ...
            <div class="sm-footer">
              <button class="btn btn-success"><i class="bi bi-download"></i> Exportar</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <?php if ($_SESSION['tipo'] == 1 || $_SESSION['tipo'] == 2 || $_SESSION['tipo'] == 7): ?>
      <!-- Por consecutivo de adopción -->
      <div class="sm-section">
        <div class="sm-section-head">
          <span class="sm-sec-icon green"><i class="bi bi-hash"></i></span>
          <span class="sm-section-title">Por consecutivo de adopción</span>
        </div>
        <div class="sm-section-body">
          <form action="php/cant_adop_excel.php" method="POST">
            ...
            <div class="row">
              <div class="col-md-3 col-12 mb-3">
                ...
                <input type="number" name="desde" class="form-control" required />
              </div>
              <div class="col-md-3 col-12 mb-3">
                <label class="control-label">Hasta <small style="color:red;">*</small></label>
                <input type="number" name="hasta" class="form-control" required />
              </div>
              <div class="col-md-3 col-12 mb-3">
                <label class="control-label">Periodo <small style="color:red;">*</small></label>
                <select name="periodo" id="periodo2" class="form-control">
                  <?php
                    $sql = "SELECT id, periodo FROM periodos ORDER BY id DESC";
                    $req = $bdd->prepare($sql); $req->execute();
                    foreach ($req->fetchAll() as $p)
