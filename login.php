...
<html lang="es">
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>Ink-pulse - CRM de Eureka Contenidos Educativos</title>
		...
		<div class="login-header box-shadow">
			...
			>
				<div class="brand-logo">
					<a href="login.php">
						<img src="vendors/images/logo_ink-pulse.png" alt="" />
					</a>
				</div>
					...
					<div class="col-md-6 col-lg-5">
						<div class="login-box bg-white box-shadow border-radius-10">
							<div class="login-title">
								<h2 class="text-center text-primary">Ingresa a Ink-pulse</h2>
							</div>
