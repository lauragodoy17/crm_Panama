                    ...
                    <?php if ($_SESSION['tipo']==3 || $_SESSION['zona']=='5656') { ?>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label for="tipo" class="control-label">Paquetes o Libros sueltos:<small style="color:red;"> *</small></label>
                      ...
                      <?php 
                        foreach($libros as $libro) {
                          ...
                          echo'<tr class="odd gradeX">';
                            ...
                            if ($libro["cod_area"] !="") {
                              echo'<td class="center"><input type="number" id="cantidad'.$libro["cod_area"].'" class="form-control" value="0" required size="4"></td>';
                              echo'<input type="hidden" name="libro[]" id="libro'.$libro["cod_area"].'">';
                            }else{
                              echo'<td class="center"><input type="number" id="cantidad'.$libro["id"].'" class="form-control" value="0" required size="4"></td>';
                              ...
                              echo"<script>
                                $('#cantidad".$libro["id"]."').keyup(function(){
                                    ...
                                    if($('#cantidad".$libro["id"]."').val() > parseInt($('#act".$libro["id"]."').text()) ) {
                                      ...
                                      $('#libro".$libro["id"]."').val(".$libro["id"]."+'/'+cant);
                                    }
