      ...
      <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
          ...
          <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
            ...
            <h4 align="center">Pedidos General libro a libro</h4><br>
              <form action="php/pedidos_sa_excel.php" method="POST">
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group" for="usuario">
                    <label>Pedidos sin adopciones<small style="color:red;"> *</small> </label>
                    <select class="form-control custom-select2" name="usuario" id="usuario1" style="width: 100%;" required>
                      ...
                      <option value="0">Todos</option>
                        <?php 
                          ...
                          $req = $bdd->prepare($sql);
                          $req->execute();
                          $distris = $req->fetchAll();

                          foreach ($distris as $distri) {
                                        
                            echo '<option value="'.$distri["id"].'">'.$distri["nombre_c"].'</option>';
                          }
              ...
              <button class="btn btn-primary">Exportar excel</button><br><br>
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="form-group" for="usuario">
                      <label>Pedidos con adopciones<small style="color:red;"> *</small> </label>
                      <select class="form-control custom-select2" name="usuario" id="usuario" style="width: 100%;" required>
                        <option selected="selected" value="">Seleccionar</option>
                        <option value="0">Todos</option>
                        <?php 
              ...
              <h4 align="center">Pedidos aprobados con OP y su estado</h4><br>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="form-group" for="usuario">
                    <label>Pedidos sin adopciones<small style="color:red;"> *</small> </label>
                      <select class="form-control custom-select2" name="usuario" id="usuario3" style="width: 100%;" required>
                        <option selected="selected" value="">Seleccionar</option>
                        <option value="0">Todos</option>
                        <?php 
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group" for="usuario">
                <label>Pedidos con adopciones<small style="color:red;"> *</small> </label>
                  <select class="form-control custom-select2" name="usuario" id="usuario4" style="width: 100%;" required>
                    <option selected="selected" value="">Seleccionar</option>
                    <option value="0">Todos</option>
                      <?php 
