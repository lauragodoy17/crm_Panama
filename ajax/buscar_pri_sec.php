...
<style>
  ...
  .pri-sec-qty-wrap .form-control {
    border-radius: 7px;
    border-color: #c4b5fd;
    font-size: 13px;
  }
  .pri-sec-qty-wrap .form-control:focus {
    border-color: #7c3aed;
...
<div class="pri-sec-wrap">
  ...
  <div class="pri-sec-row">
    ...
    <div class="pri-sec-qty-wrap">
      <span>Cantidad <small style="color:red;">*</small></span>
      <input type="number" class="form-control cantidad_pri_sec" name="cantidad_pri_sec[]" placeholder="0">
    </div>
  </div>
  <?php endforeach; ?>
</div>
