                      ...
                      <?php 
                        foreach($pedidos as $pedido) {
                          $promotor= $pedido["nombres"]." ".$pedido["apellidos"];
                            ...
                            echo'<td class="center"><a href="muestreo_colegio_estado.php?id_pedido='.$pedido["id"].'">'.$pedido["colegio"].'</a></td>';
