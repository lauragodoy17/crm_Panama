    ...
    if($_FILES["archivo"]["type"]=="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") {
        ...
        if (move_uploaded_file($_FILES['archivo']['tmp_name'], $fichero_subido)) {
            ...
            for ($row = 4; $row <= $highestRow; $row++){
                    ...
                    $sql = "SELECT id FROM proveedores WHERE documento='".$documento."'";
                    ...
                    if ($cliente["id"] =="") {
                        ...
                        $sql_z = "INSERT INTO proveedores (proveedor,documento,direccion,telefonos,ciudad) VALUES ('".$n_cliente."', '".$documento."', '".$direccion."', '".$telefonos."', '".$ciudad."')";

                    }else{

                       $sql_z = "UPDATE proveedores SET proveedor='".$n_cliente."', documento='".$documento."', direccion='".$direccion."', telefonos='".$telefonos."', ciudad='".$ciudad."' WHERE id='".$cliente["id"]."'";
            ...
            echo "<script>alert('Los proveedores se han actualizado');window.location='../proveedores.php'</script>";
        } else {
