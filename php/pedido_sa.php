<?php
	...
	try {
		...
		$mail->Body    = '<p style="font-size: 17px;">El usuario: '.$promo["promotor"].' hizo la solicitud de pedido #'.$pedido["id"].' para: '.$_POST["colegio"].'. Haz clic <a href="https://eurekalibros.com.co/promotores/pedido_colegio2.php?id_pedido_dist='.$pedido['id'].' ">aquí</a> para revisarlo<p>';
